<%@ Page Title="" Language="C#" MasterPageFile="~/Company/Adminmaster.master" AutoEventWireup="true" CodeFile="SoldItemList.aspx.cs" Inherits="Company_Default" %>
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
                    <Columns>
                        ...
                        <asp:BoundField DataField="sd_itemqty" HeaderText="Qty" />
                        <asp:BoundField DataField="product_price" HeaderText="Rate" />
                        <asp:BoundField DataField="sd_itemrate" HeaderText="Total" />
                    </Columns>

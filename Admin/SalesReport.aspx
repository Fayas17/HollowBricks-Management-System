<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Adminmaster.master" AutoEventWireup="true" CodeFile="SalesReport.aspx.cs" Inherits="Company_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td>
                            <asp:DropDownList ID="ddlcompany" runat="server" OnSelectedIndexChanged="ddlcompany_SelectedIndexChanged" Width="250px">
                            </asp:DropDownList>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
